...
module YEA
  module XPARAM
    ...
    # whatever the original HIT rate is.
      :hit_n_value => "0",
      #"(atk + agi) / 2",
      :hit_formula => "base_hit",
      #"(n / (100.0 + n)) * 0.250 + 0.050 + base_hit * 2/3",
    ...
    # whatever the original EVA rate is.
      :eva_n_value => "0",
      #"(agi + luk) / 2",
      :eva_formula =>  "base_eva",
      #"(n / (256.0 + n)) * 0.250 + 0.000 + base_eva",
    ...
    # whatever the original CRI rate is.
      :cev_n_value => "0",
      #"agi * 0.75 + luk * 0.25",
      :cev_formula => "base_cev",
      #"(n / (512.0 + n)) * 0.167 + 0.000 + base_cev",
    ...
    # whatever the original MEV rate is.
      :mev_n_value => "0",
      #"(mdf + luk) / 2",
      :mev_formula => "base_mev",
      #"(n / (256.0 + n)) * 0.250 + 0.000 + base_mev",
    ...
    # whatever the original GRD rate is.
      :grd_n_value => "0",
      #"(self.def) / 2",
      :grd_formula => "base_grd",
      #"(n / (256.0 + n)) * 0.333 + 0.000 + base_grd",
    ...
    # whatever the original PDR rate is.
      :pdr_n_value => "0",
      #"self.def",
      :pdr_formula => "base_pdr",
     # "base_pdr - (n / (256.0 + n)) * 0.500 - 0.000",
    ...
    # whatever the original PDR rate is.
      :mdr_n_value => "0",
      #"mdf",
      :mdr_formula => "base_mdr",
      #"base_mdr - (n / (256.0 + n)) * 0.500 - 0.000",
